...
for i in range(0,5):
    ...
    adv = Broadcast.Broadcast(bus, 0, "local1", [0x00, 0x01, 0x03,  0x01, 0x04,0x01, 0x02, 0x03, 0x04,0x00, 0x04,0x01, 0x03, 0x03,  0x01, 0x04,0x01, 0x02, 0x03, 0x03, 0x04,0x00,  0x00, 0x02], 53.468380, -2.266240)
    start_advertising()
